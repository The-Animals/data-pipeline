...
class JSTAnalyzer:
    ...
    def analyze(self):
        remove('topic_analysis/jst/input/data.dat')
        open('topic_analysis/jst/input/data.dat', 'x')
        self._load_data('speeches', 'topic_analysis/jst/input/data.dat')
    ...
    def estimate_model(self):
        run(['topic_analysis/jst/Debug/jst', '-inf', '-config', 'topic_analysis/jst/data.properties'])
